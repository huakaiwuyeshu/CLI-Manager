...
This project is indexed by GitNexus as **CLI-Manager** (9552 symbols, 18560 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
