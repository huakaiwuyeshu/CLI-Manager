...
This project is indexed by GitNexus as **CLI-Manager** (8159 symbols, 15180 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
